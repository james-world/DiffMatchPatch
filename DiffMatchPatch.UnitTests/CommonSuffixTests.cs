...
namespace DiffMatchPatch.UnitTests
{
    public class CommonSuffixTests
    {
        ...
        {
            DiffTools.CommonSuffixLength(text1, text2).Should().Be(0);
        }
        ...
        {
            DiffTools.CommonSuffixLength(input, input).Should().Be(input.Length);
        }
        ...
        {
            DiffTools.CommonSuffixLength(text1, text2).Should().Be(suffixLength);
        }
    }
}